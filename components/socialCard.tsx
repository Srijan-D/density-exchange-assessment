        ...
        <section className='mt-28 flex  md:mt-40 md:px-4'>
            <MotionDiv
                ...
                <MotionDiv
                    ...
                    <p className='text-sm font-semibold  text-[#53553]'>Let your friends, family, and co-workers rate your skills.</p>
                    <h1 className='mt-3 text-xl font-bold text-black md:text-3xl'>Ever Wondered what others think of you?</h1>
