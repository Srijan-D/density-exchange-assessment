    ...
    return (
        <section className='mt-40 flex items-center justify-center px-4 font-[Montserrat] md:px-24 '>
            <MotionDiv
                ...
                <p className='text-sm font-semibold text-[#333333] '>We take privacy seriously</p>
                <h1 className='text-3xl font-bold text-black'>Before you get started</h1>
                <p className='text-lg font-semibold text-[#535353]'>"We wont share answers with anyone (and won't ever tell
                    <br />
                ...
                <p className='text-sm font-medium text-[#808080] '>Takes only 5 minutes</p>
