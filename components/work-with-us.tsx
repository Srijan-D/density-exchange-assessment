...
import { CardData } from "@/db/index"

import boo from "../public/boo.svg"
import { MotionDiv } from "./motion-div-wrapper"
import { MotionHeading } from "./motion-wrapper"

type TProps = Omit<(typeof CardData)[number], "key"> & { key: number }

function WorkCard({ heading, info }: TProps) {
  return (
          ...
          >
            <div className="flex flex-[0.7] flex-col p-4 md:px-6">
              <Image
                ...
                className="-ml-5"
              />
              <h2 className="mb-2 text-start text-2xl font-semibold text-[#363636]">
                About
              </h2>
              <p className="text-start font-semibold text-[#535353]">
            ...
            <div className="flex flex-[0.3] flex-col gap-1 rounded-3xl bg-[#FEF6F0] p-2  md:px-6">
              ...
              <p className="mb-3 text-start font-semibold text-[#535353]">
        ...
        >
          <div className="flex items-center justify-center md:justify-end">
            <MotionHeading
              ...
              whileInView={{ x: 0, scale: 1, opacity: 1 }}
              viewport={{ once: true }}
              className="text-center text-3xl font-bold text-[#6B4DEE] md:text-end md:text-4xl"
            >
              ahead
            </MotionHeading>
          </div>
